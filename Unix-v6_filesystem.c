...
//   NETID:  sxs190047
//
//CLASS: Operating System (CS5348.001)
//
 *
 * **********Running the program*************:
...
// function to load v6 filesystem//
...
// function to create new file in the v6 file system with the content of the external file//
...
// function to create new directory in the file system//
